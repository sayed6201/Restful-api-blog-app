...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paginationLayout = findViewById(R.id.pagination_btn);

        postArrayList = new ArrayList<>();
        gson = new Gson();
    }

    public void searchKeyAction(View v){

        getSearchedPosts(keyEt.getText().toString());

//        if(listAdapterWithRecycleView == null){
...
//        }
    ...
    public void getSearchedPosts( String key){
        //getting all the posts
        // Tag used to cancel the request
        String tag_json_obj = "json_obj_req";
        String url ="http://10.0.2.2/projects/api-vue-lara/public/api/search/"+key;
...
//                            textView.setText(response.getJSONArray("data").get(3).toString()+"");
                            ...
                            listAdapterWithRecycleView = new ListAdapterWithRecycleView(SearchActivity.this,postArrayList);
